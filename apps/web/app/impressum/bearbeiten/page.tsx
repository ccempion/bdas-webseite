 ...
 * The public Impressum is always reachable, but authoring it requires the
 * content module, so the editor route is gated on the `content` flag.
 */
export default async function ImpressumBearbeitenPage() {
