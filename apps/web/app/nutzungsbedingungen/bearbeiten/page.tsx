...
export const metadata: Metadata = {
  title: "Seite bearbeiten — Nutzungsbedingungen",
  robots: { index: false },
};

/**
 * Editor is board-only; everyone else gets a 404 (no existence leak, spec §6).
 * The public Nutzungsbedingungen page is always reachable, but authoring it
 * requires the content module, so the editor route is gated on the `content`
 * flag.
 */
export default async function NutzungsbedingungenBearbeitenPage() {
