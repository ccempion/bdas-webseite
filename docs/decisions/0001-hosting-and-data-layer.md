...
- **Date:** 2026-05-10
- **Supersedes:** —
- **Superseded by:** ADR 0009 — _WordPress clause only_ (the "WordPress stays on its existing host; only the SSO bridge cookie connects it" line is void; the platform is standalone). Hosting/data-layer decisions otherwise stand.
