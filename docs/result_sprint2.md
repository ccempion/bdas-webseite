...
- Schema + 0001*init.sql: one table groups (id, slug, name, city, university, description,
  contact_email, instagram_url, website_url, status, timestamps). join_fee*\* deliberately omitted  
  (Phase 6).
